...
library.themes = {
    {
        ...
        theme = {
            ...
            ['Selected Tab Background']   = fromrgb(24,24,24);
            ...
            ['Option Text 2']             = fromrgb(167,167,167);
    ...
    function self.NewWindow(data)
        ...
        do
            ...
            objs.columnholder1 = utility:Draw('Square', {
                Size = window.huy and newUDim2(.98, 0, .96, 0) or newUDim2(.48, 0, .96, 0);
            ...
            if typeof(bool) == 'boolean' then
                ...
                for _,v in next, objs do
                    if v.Object.Transparency ~= 0 then
                        task.spawn(function()
                            if window.openyaica == false or window.openyaica == false and bool then
                ...
                function section:AddHumanoid(data)
                    ...
                    do
                        ...
                        objs.background = utility:Draw('Image', {
                            Size = udd-- newUDim2(0,188,0,268);
                            Position = udp --newUDim2(0,1,0,1);
